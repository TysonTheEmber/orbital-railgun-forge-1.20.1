...
public final class OrbitalConfig {
    ...
    static {
        ...
        ALLOW_ENTITY_DAMAGE_IN_CLAIMS = builder
                .comment("If true, railgun can damage entities inside claims only if the shooter has permission")
                .define("allowEntityDamageInClaims", false);
        ALLOW_BLOCK_BREAK_IN_CLAIMS = builder
                .comment("If true, railgun can break blocks inside claims only if the shooter has permission")
                .define("allowBlockBreakInClaims", false);
        ALLOW_EXPLOSIONS_IN_CLAIMS = builder
                .comment("If true, railgun explosions are allowed inside claims only if the shooter has permission")
                .define("allowExplosionsInClaims", false);
        OPS_BYPASS_CLAIMS = builder
                .comment("If true, ops (permission level >= 2) bypass claim checks")

...
public final class OrbitalConfig {
    ...
    static {
        ...
        ALLOW_ENTITY_DAMAGE_IN_CLAIMS = builder
                .comment("If true, the railgun can damage entities inside claims when the shooter has permission")
                .define("allowEntityDamageInClaims", false);
        ALLOW_BLOCK_BREAK_IN_CLAIMS = builder
                .comment("If true, the railgun can break blocks inside claims when the shooter has permission")
                .define("allowBlockBreakInClaims", false);
        ALLOW_EXPLOSIONS_IN_CLAIMS = builder
                .comment("If true, railgun explosions are allowed inside claims when the shooter has permission")
                .define("allowExplosionsInClaims", false);
        OPS_BYPASS_CLAIMS = builder
                .comment("If true, operators (permission level >= 2) bypass FTB claim checks")
